...
SOURCE_IMAGES = "imagenes_filtradas_2"
...
def predict_folder(folder_path, save_csv=True, show_results=True):
    ...
    # GUARDAR CSV
    if save_csv:
        csv_path = os.path.join(os.getcwd(), "predicciones.csv")  # Guardar en raíz del proyecto
...
carpeta_inferencia = "crops_clahe_processed"
